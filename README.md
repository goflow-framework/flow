...
- Security checklist
    ...
    - Set an explicit body size limit in production. `WithDefaultMiddleware` applies a 4 MiB cap automatically; override with `WithBodyLimit` for your use case. See [`docs/body-limit.md`](docs/body-limit.md) for per-route overrides and choosing the right limit.
+
