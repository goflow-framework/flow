...
// It implements the shared exec.Executor interface. This package exists to
// host the Flow-owned executor implementation under pkg/flow/exec so the
// App can opt-in to an owned executor that the App will shut down.
